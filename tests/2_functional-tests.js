  ...
  suite("Function displayTranslation()", () => {
    ...
    */
    test("Translation appended to the `translated-sentence` `div`", done => {
      ...
      Translator.displayTranslation(textArea.value, "american-to-british");
    ...
    */
    test("'Everything looks good to me!' message appended to the `translated-sentence` `div`", done => {
      ...
      Translator.displayTranslation(textArea.value, "american-to-british");
      assert.strictEqual(translationDiv.innerText, output);
      done();
    });
    ...
    */
    test("'Error: No text to translate.' message appended to the `translated-sentence` `div`", done => {
      ...
      Translator.displayTranslation(textArea.value, "american-to-british");
      assert.strictEqual(errorDiv.innerText, output);
      done();
    });
  });
  ...
  suite("Function ____()", () => {
    ...
    */
    test("Text area, `translated-sentence`, and `error-msg` are cleared", done => {
      ...
      const translationDiv = document.getElementById("translated-sentence");
      const errorDiv = document.getElementById("error-msg");
      textArea.value = "chippy";
      translationDiv.textContent = "fish-and-chip shop";
